...
if(experimentVersion == 1){
  ggsave(paste(allLabels[[situation]], "_nonsocial.pdf", sep=""),plot= egg::set_panel_size(p=nonSocPlot, width = unit(15, "cm"), height=unit(8, "cm")), path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/Experiment1/", allLabels[[situation]], sep=""))
  ggsave(paste(allLabels[[situation]], "_social.pdf", sep=""),plot=egg::set_panel_size(p=socPlot, width = unit(15, "cm"), height=unit(8, "cm")),path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/Experiment1/", allLabels[[situation]], sep=""))
  ggsave(paste(allLabels[[situation]], "_scatter.pdf", sep=""),plot=egg::set_panel_size(p=scatter, width = unit(15, "cm"), height=unit(8, "cm")),path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/Experiment1/", allLabels[[situation]], sep=""))
}

if(experimentVersion == 2){
  ggsave(paste(allLabels[[situation]], "_nonsocial.pdf", sep=""),plot= egg::set_panel_size(p=nonSocPlot, width = unit(15, "cm"), height=unit(8, "cm")),path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/", allLabels[[situation]], sep=""))
  ggsave(paste(allLabels[[situation]], "_social.pdf", sep=""),plot= egg::set_panel_size(p=socPlot, width = unit(15, "cm"), height=unit(8, "cm")),path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/", allLabels[[situation]], sep=""))
  ggsave(paste(allLabels[[situation]], "_scatter.pdf", sep=""),plot= egg::set_panel_size(p=scatter, width = unit(15, "cm"), height=unit(8, "cm")),path=paste("C:/Users/paynesc/Documents/research/Plots/PaperPlots/", allLabels[[situation]], sep=""))
}
