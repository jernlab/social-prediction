...
filterOutliers<-function(experimentData, story){
  library(tidyverse)
  averages <- list(rep(0,5), rep(0,5))
  numGuessesPerLevel <- list(rep(0,5), rep(0,5))
  ...
  stdDevs <- list(c(1:5), c(1:5)) #Social = Row 1, Non-Social = Row 2
